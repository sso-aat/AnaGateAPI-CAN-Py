...
// ----------------------------------------------------------------------------
// $Id: AnaGateDLL.h,v 1.10 2009/04/30 14:20:07 stefanwelisch Exp $
//
// $Log: AnaGateDLL.h,v $
// Revision 1.10  2009/04/30 14:20:07  stefanwelisch
// Define f?r LUA_LIB hinzugef?gt
//
...
// ANAI2CDLL_API-Funktionen als aus einer DLL importiert, w?hrend die DLL mit diesem Makro
...
extern "C"
{
   ...
   */
   ANAGATEDLL_API AnaInt32 ANAGATEDLL_CALLING DLLInfo( char *pcMessage, AnaInt32 nMessageLen );
#endif
   ...
   */
   ANAGATEDLL_API AnaInt32 ANAGATEDLL_CALLING DeviceInfo( AnaInt32 hHandle, struct SAnaGateDeviceInfo *pDeviceInfo );
